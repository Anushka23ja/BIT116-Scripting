...
/* 	INSTRUCTIONS: Part 1
	...
	(2) Initialize the array elements with these city names (in UPPERCASE letters):
		...
		WOODINVILLE
*/
var city = new Array["BELLEVUE","BOTHELL","DUVALL","EDMONDS","KENMORE","KIRKLAND","LAKE FOREST PARK","LYNNWOOD","MONROE", "MOUNTLAKE TERRACE", "REDMOND", "SEATTLE", "SHORELINE", "TACOMA", "WOODINVILLE"];
//////////////////////////////////////////////////////////////////////////////////////////////////////
...
function guessStatus(){
	document.form1.tries.value = "Tries: " + tries; 
}
...
*/
function newGame(){
    window.confirm("Do you want to start a new game?");
    window.location.reload(); 
    document.form1.hint.value == "Enter your guess below and click Guess button!";
