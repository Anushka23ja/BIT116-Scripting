...
function resetGame() {
	...
	document.form1.stateClue.value = "The state to guess is: " + stateName.toTitleCase() + ".";
document.form1.stateClue.value = "Enter the state capital below and click Guess";	document.form1.guess1.value = '';
	unDisable();
}
...
function newGame(){
	score = 0;
	document.form1.current1.value = ("Current Score: " + document.form1.top1.value);
	resetGame()
}
